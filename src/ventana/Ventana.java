...
public class Ventana extends javax.swing.JFrame {
    //Vamos a utilizar una clase "tiempo" de swing 
    ...
    public Ventana() {
        ...
        tiempo = new Timer(10,acciones); //Cada 10 milisegundos van a ocurrir estas acciones
    }
    ...
    private void initComponents() {
        ...
        imagenCronometro.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/crono.png"))); // NOI18N
        panel.add(imagenCronometro, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 150, 150));
        ...
        panel.add(etiquetaCronometro, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 10, -1, -1));
        ...
        panel.add(etiquetaTiempo, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 60, 260, 50));
        ...
        panel.add(botonIniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 130, 100, 30));
        ...
        panel.add(botonPausar, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 130, 100, 30));
        ...
        panel.add(botonDetener, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 130, 100, 30));

        etiquetaFondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/atletismo.jpg"))); // NOI18N
    ...
    private void botonIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonIniciarActionPerformed
        tiempo.start(); //con este metodo queremos que inicie el tiempo 
        botonIniciar.setEnabled(false); //para que una vez iniciado ya no lo vuelva a presionar
    ...
    private void botonPausarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonPausarActionPerformed
        tiempo.stop(); //vamos a detener el tiempo 
